...
Para empezar, a priori entendimos como proxy de éxito la cantidad de dueños de un juego, aparte de nuestro conocimiento externo de la industria. Sumado a lo anterior, mediante técnicas de clustering produjimos una variable que estima el éxito de los juegos del dataset que se ajusta lo suficiente a nuestras hipótesis. Con esto, procedimos a analizar los datos en torno a la variable `dueños_promedio` y la nueva variable `Target`.
...
- Luis Jiménez: Autor del [repositorio](https://github.com/SoraSpace769/CC5206_steam_games) del proyecto en GitHub. Revisión general del reporte para orden lógico. Redacción de la sección 3 y análisis de gráficos de la sección 2. Asistencia en redacción de la sección 4. Redacción de la presentación.
- Germán Matamoro: Revisión parcial y final del reporte y preparación de presentación. Revisión deatallada de gráficos de la sección 2. Redacción general de la sección 4. Asistencia en redacción de la presentación.
- Nicolás Olivero: Exploración del dataset y análisis de resultados de la sección 2. Colaboración en repositorio de GitHub del proyecto. Asistencia en redacción de la sección 4. Redacción de la presentación.
- Alexander Walmsley: Etiquetado de gráfico y ordenamiento de bloques de código del reporte Rmd. Asistencia en redacción de la sección 4. Redacción de la presentación.
